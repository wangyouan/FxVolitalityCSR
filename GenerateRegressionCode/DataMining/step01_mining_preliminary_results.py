...
#                 'CGOV_Score': -1, 'Resource_Use_Score': -1, 'Emissions_Score': -1,
#                 'Environmental_Innovation_Score': -1,
...
#                 'CASH_RATIO': 1}
DEP_VAR_DICT = {'SOC_Score': -1, 'Resource_Use_Score': -1, 'Environmental_Innovation_Score': -1,
                'Human_Rights_Score': -1, 'CASH_LN': 1, 'CASH_RATIO': 1}
CTRL_VARS = ['GDP_LN GDP_GROWTH GDP_CAP_LN IMPORT_RATIO EXPORT_RATIO', 'at_ln', 'LEVERAGE', 'PTBI', 'VOL_PTBI',
             'FIRM_AGE']
...
if __name__ == '__main__':
    cmd_list = ['[data]',
                'file_path = {}'.format(os.path.join(const.RESULT_PATH, '20200216_fx_csr_reg_df_no_basket27.dta')),
