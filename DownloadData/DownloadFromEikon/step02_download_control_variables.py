...
CTRL_VARS = ['TR.Cash', 'TR.TotalAssetsReported', 'TR.NormalizedEbitda', 'TR.ReportedReturnOnAssets',
             'TR.ReportedReturnOnEquity', 'TR.ReportedTotalLiabilities', 'TR.TangibleBookValueRptd',
             'TR.CapitalExpenditures', 'TR.EPSActValue', 'TR.PriceToBVPerShare', 'TR.RIC', 'CTR_LOC1',
             'TR.AssetCountry', 'TR.HQCountryCode']
